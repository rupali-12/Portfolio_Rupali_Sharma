...
//           </p>
//         </div>
//         {/* We need to add name property  this is important for git form.io to work  */}
//         <input
//           className="p-2 bg-[#050609] rounded-md text-white placeholder-gray-500 text-2xl focus:outline-none"
//           type="text"
//           placeholder="Name"
//           name="name"
//         />
//         <input
//           className="my-4 p-2 bg-[#050609] rounded-md text-white placeholder-gray-500 text-2xl focus:outline-none"
//           type="email"
//           placeholder="Email"
//           name="email"
//         />
...
//         ></textarea>
//         <button
//           className="text-white border-2 border-cyan-400 hover:bg-gradient-to-r from-cyan-500 to-blue-900 rounded-md px-4 py-3 my-8 mx-auto flex items-center text-2xl focus:outline-none"
//           type="submit"
//         >
//           Let's Connect
//         </button>
